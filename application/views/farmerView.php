...
<body>
        ...
        <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p class="text-muted"><?php echo $farmer_number; ?></p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <strong><i class="fas fa-venus-mars mr-1"></i> Gender</strong>
                      <p class="text-muted"><?php echo ucfirst($gender); ?></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p class="text-muted"><?php echo $f_name . ' ' . $m_name . ' ' . $l_name . ' ' . $suffix; ?></p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p class="text-muted">
                        <?php echo !empty($addressParts) ? implode(', ', $addressParts) : 'Address not available'; ?>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p class="text-muted"><?php echo date("F j, Y", strtotime($age)); ?></p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <strong><i class="fas fa-phone mr-1"></i> Phone Number</strong>
                      <p class="text-muted"><?php echo $cell_number; ?></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="card card-pink card-outline">
              <div class="card-header">
                <h1 class="card-title">
                  <strong><?php echo $f_name . ' ' . $m_name . ' ' . $l_name . ' ' . $suffix; ?></strong>'s Personal
                  Records
                </h1>
                  ...
                  <table id="savedReportTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      if (!empty($catches)) {
                        ...
                        echo "<tr><td colspan='4'>No logs found for this farmer.</td></tr>";
  ...
  <script>
    $(document).ready(function () {
      ...
      var totalData = <?php echo json_encode($monthly_catch_data); ?>;
      var speciesChartData = <?php echo json_encode($species_chart_data); ?>;
      var speciesNames = <?php echo json_encode(array_keys($species_chart_data)); ?>;
