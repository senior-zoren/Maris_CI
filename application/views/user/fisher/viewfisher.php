    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= base_url('agriculturist/fisher_info_hub') ?>" class="nav-link" style="color: #28a745;"><i
      ...
      <section class="content-header">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Fisherman Records</h1>
                <p>This page highlights the individual chart for the monthly recorded marine capture by the municipal
          ...
          <div class="row">
              ...
              <div class="card card-success card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <?php if (!empty($vesselImage)): ?>
                      <h3>Vessel Image</h3>
                      <img src="<?= $vesselImage; ?>" alt="Vessel Image"
                        style="max-width: 95%; height: auto; object-fit: contain;">
                    <?php else: ?>
                      <p>No vessel image available.</p>
                    <?php endif; ?>
                  </div>
                  <div class="text-start">
                    <h3 class="profile-username text-muted text-center">
                      <small>
                        <?php
                        echo $fisherDetails['f_name'] . ' ' . $fisherDetails['m_name'] . ' ' . $fisherDetails['l_name'] . ' ' . $fisherDetails['suffix'];
                        echo '<br>Brgy. ';

                        // Safely process farmAddressParts
                        $addressParts = isset($fisherAddress) ? [$fisherAddress['brgy_name'], $fisherAddress['city'], $fisherAddress['province']] : [];
                    ...
                    <a href="vesselPage.php" style="color: #28a745;"><i class="fas fa-arrow-left mr-1"></i>Go to vessel
                      list</a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <p class="text-muted"><?= $fisherDetails['fisher_number']; ?></p>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <strong><i class="fas fa-venus-mars mr-1"></i> Gender</strong>
                        <p class="text-muted"><?= ucfirst($fisherDetails['gender']); ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <p class="text-muted">
                          <?= $fisherDetails['f_name'] . ' ' . $fisherDetails['m_name'] . ' ' . $fisherDetails['l_name'] . ' ' . $fisherDetails['suffix']; ?>
                        </p>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <p class="text-muted"><?= implode(', ', $fisherAddress); ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <p class="text-muted"><?= date("F j, Y", strtotime($fisherDetails['age'])); ?></p>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <strong><i class="fas fa-phone-alt mr-1"></i> Phone Number</strong>
                        <p class="text-muted"><?= $fisherDetails['cell_number']; ?></p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                  <a href="../shared/fisherIdPrint.php?fisher_id=<?= $fisher_id; ?>" rel="noopener"
                    target="_blank" class="btn btn-outline-success btn-flat float-right"><i class="fas fa-print"></i>
                    Print
                    Profile</a>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card card-success card-outline">
                <div class="card-header">
                  <h1 class="card-title">
                    <strong><?= $fisherDetails['f_name'] . ' ' . $fisherDetails['m_name'] . ' ' . $fisherDetails['l_name'] . ' ' . $fisherDetails['suffix']; ?></strong>'s
                    Personal Records
                  </h1>
            ...
            <div class="col-md-12">
              <div class="card card-white card-outline">
                ...
                <div class="card-body">
                  ...
                  <div class="my-2">
                    <table id="savedReportTable" class="table table-striped">
                      <thead>
                        <tr>
                          <th>Fisherman</th>
                          <th>Species</th>
                      ...
                      <tbody>
                        ...
                        if (!empty($fisherCatches)) {
                          foreach ($fisherCatches as $catch) {
                            ...
                            $fullName = $catch['first_name'] . ' ' . $catch['last_name'];

                            echo "<tr>
                                      <td>{$fullName}</td>
                                      <td>{$catch['species']}</td>
                                      <td>{$catch['quantity']}</td>
                                      <td>{$catch['equipments']}</td>
                                      <td>{$catch['distance']}</td>
                                      <td>{$catch['operation_start']}</td>
                                      <td>{$catch['operation_end']}</td>
